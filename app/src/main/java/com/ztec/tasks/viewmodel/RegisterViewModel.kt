...
class RegisterViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun register(name: String, email: String, password: String, passwordConfirmation: String, deviceToken: String) {
        personRepository.register(name, email, password, passwordConfirmation, deviceToken, object: APIListener<PersonModel>{
